...
[ -z "$PROFILER_OUTPUT_DIR" ] && PROFILER_OUTPUT_DIR="/tmp"
[ -z "$PROFILER_OUTPUT_NAME" ] && PROFILER_OUTPUT_NAME="cachegrind.out.%p-%H-%R"
[ -z "$PROFILER_ENABLE_TRIGGER" ] && PROFILER_ENABLE_TRIGGER="1"
[ -z "$PROFILER_ENABLE" ] && PROFILER_ENABLE="0"
...
s#\$PROFILER_OUTPUT_DIR#$PROFILER_OUTPUT_DIR#g
s#\$PROFILER_OUTPUT_NAME#$PROFILER_OUTPUT_NAME#g
s#\$PROFILER_ENABLE_TRIGGER#$PROFILER_ENABLE_TRIGGER#g
s#\$PROFILER_ENABLE#$PROFILER_ENABLE#g
